...
public class SourceStand : MonoBehaviour
{
	...
	public void SetElement()
	{
		...
		G = bodyItem.childsPorts[0].PortID_Global;
		V = bodyItem.childsPorts[1].PortID_Global;
		Global.MyCircuit.entities.Add(new VoltageSource(EntityID.ToString(), V.ToString(), string.Concat(EntityID.ToString(), "_rPort"), E));
		Global.MyCircuit.entities.Add(new Resistor(string.Concat(EntityID.ToString(), "_r"), string.Concat(EntityID.ToString(), "_rPort"), G.ToString(), R));
